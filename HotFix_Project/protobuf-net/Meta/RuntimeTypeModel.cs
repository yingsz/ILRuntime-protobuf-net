...
//#endif
        ...
        internal int GetKey(Type type, bool demand, bool getBaseKey)
        {
            ...
            //try
         //   {
                Debug.LogWarningFormat("GetKeyImpl111111########{0},{1},{2}", type.Name, demand, getBaseKey);
          ...
          /*  }
            ...
            {
                Debug.LogWarningFormat("GetKeyImpl########{0},{1},{2}", type.Name, demand, getBaseKey);
        ...
        protected internal override void Serialize(int key, object value, ProtoWriter dest)
        {
            ...
            Debug.LogFormat("Serialize#######{0}", ((MetaType)types[key]).Serializer == null);
